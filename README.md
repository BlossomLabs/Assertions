...
Combinators v1.0  0xA55EC0b792D962624807961E40eb217649d4d07c   (versionable periphery)
```
...
Assertion functions revert or pass — they judge. Everything that *computes* lives in the separate `Combinators` contract (`0xA55EC0b792D962624807961E40eb217649d4d07c`): each function is a small composable building block, and nested `(target, data)` operands in calldata compose the blocks into arbitrary expressions. The core consumes the result by pointing any call assertion at the Combinators address.
...
These live at the Combinators address (`0xA55EC0b792D962624807961E40eb217649d4d07c`), not on the core. See [Combinators — computing values](#combinators--computing-values) for usage.
