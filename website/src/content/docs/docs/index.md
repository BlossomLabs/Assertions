---
title: Overview
description: What Assertions is, how the three contracts split responsibilities, and where they live.
---
...
It ships as **three contracts** with one tagline: **the core reads and judges; Operations compute.**
...
Collections         v1.0  0xc6D85B72bdF8040f61f4CD7957c7aa8e5f30a47f   (generic collections)
Expressions         v1.0  0xc45C579021623712eE3f61D066a24218F6e01E22   (typed expression graphs)
```
...
- **Inline constraints**: `EQ`, `GTE`, `LTE` and `IN` (inclusive range) validate any fetched value; everything richer routes through a read-spliced Operations comparison judged `EQ 1`
...
- [Operations](/docs/operators): the computation vocabulary and how `read` splicing composes it
